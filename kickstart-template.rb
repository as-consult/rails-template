...
after_bundle do
  ...
  # Solve turbo-links issues with flash notice (deprecated since devise gem 4.9.0)
  ...
  run "curl -L https:///raw.githubusercontent.com/alexstan67/rails-template/master/kickstart/controllers.tar.gz > controllers.tar.gz"
